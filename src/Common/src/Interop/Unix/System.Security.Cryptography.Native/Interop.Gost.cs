...
internal static partial class Interop
{
    ...
    {
        [DllImport("libcapi20.so", EntryPoint = "CryptoNative_RsaCreate")]
        internal static extern SafeRsaHandle RsaCreate();

        [DllImport("libcapi20.so", EntryPoint = "CryptoNative_RsaUpRef")]
        [return: MarshalAs(UnmanagedType.Bool)]
        internal static extern bool RsaUpRef(IntPtr rsa);

        [DllImport("libcapi20.so", EntryPoint = "CryptoNative_RsaDestroy")]
        internal static extern void RsaDestroy(IntPtr rsa);

        [DllImport("libcapi20.so", EntryPoint = "CryptoNative_DecodeRsaPublicKey")]
        ...
        [DllImport("libcapi20.so", EntryPoint = "CryptoNative_RsaPublicEncrypt")]
        ...
        [DllImport("libcapi20.so", EntryPoint = "CryptoNative_RsaPrivateDecrypt")]
        ...
        [DllImport("libcapi20.so", EntryPoint = "CryptoNative_RsaSignPrimitive")]
        ...
        [DllImport("libcapi20.so", EntryPoint = "CryptoNative_RsaVerificationPrimitive")]
        ...
        [DllImport("libcapi20.so", EntryPoint = "CryptoNative_RsaSize")]
        internal static extern int RsaSize(SafeRsaHandle rsa);

        [DllImport("libcapi20.so", EntryPoint = "CryptoNative_RsaGenerateKeyEx")]
        ...
        [DllImport("libcapi20.so", EntryPoint = "CryptoNative_RsaSign")]
        [return: MarshalAs(UnmanagedType.Bool)]
        ...
        [DllImport("libcapi20.so", EntryPoint = "CryptoNative_RsaVerify")]
        [return: MarshalAs(UnmanagedType.Bool)]
        ...
        [DllImport("libcapi20.so", EntryPoint = "CryptoNative_GetRsaParameters")]
        [return: MarshalAs(UnmanagedType.Bool)]
        ...
        [DllImport("libcapi20.so", EntryPoint = "CryptoNative_SetRsaParameters")]
