	...
	abstract class Asn1Time : Asn18BitCharString, IComparable
	{
		...
		public virtual int DiffHour
		{
			...
			set
			{
				...
				{
					throw new FormatException("Asn1InvalidDiffHourValue");
		...
		public virtual int Year
		{
			...
			set
			{
				...
				{
					throw new FormatException("Asn1InvalidYearValueForDayAndMonth");
		...
		public virtual int Month
		{
			...
			set
			{
				...
				{
					throw new FormatException("Asn1InvalidMonthValueForDayAndYear");
		...
		public virtual int Day
		{
			...
			set
			{
				...
				{
					throw new FormatException("Asn1InvalidDayValueForMonthAndYear");
		...
		protected override int Encode(Asn1BerEncodeBuffer buffer, bool explicitTagging, Asn1Tag tag)
		{
			...
			if (DerRules != flag)
			{
				...
				if (!CompileString())
				{
					throw new FormatException("Asn1TimeStringCouldNotBeGenerated");
		...
		public virtual void SetDiff(int inMinutes)
		{
			...
			{
				throw new FormatException("InvalidDiffValue");
