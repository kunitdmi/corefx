namespace System.Security.Cryptography
{
	...
	class BigInteger
	{
		...
		public void Init(string val, int radix)
		{
			...
			{
				throw new FormatException("Asn1InvalidFormatForBigIntegerValue");
			}

			if (val.Length == 0)
			{
				throw new FormatException("Asn1ZeroLengthBigInteger");
			}
			...
			if (index != -1)
			{
				if (index != 0)
				{
					throw new FormatException("Asn1IllegalEmbeddedMinusSign");
				}
			...
			else
			{
				...
				{
					throw new FormatException("Asn1IllegalDigit");
				}
		...
		public void SetData(byte[] ivalue)
		{
			...
			{
				throw new FormatException("Asn1TooBigIntegerValue");
