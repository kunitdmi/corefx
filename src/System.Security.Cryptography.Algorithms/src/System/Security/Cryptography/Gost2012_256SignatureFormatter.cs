...
namespace System.Security.Cryptography
{
    ...
    [ComVisible(true)]
    public class Gost2012_256SignatureFormatter : AsymmetricSignatureFormatter
    {
        /// <summary>
        /// Ключ.
        /// </summary>
        ...
        /// <summary>
        /// Создание объекта класса <see cref="Gost2012_256SignatureFormatter"/>.
        /// </summary>
        public Gost2012_256SignatureFormatter()
        {
            _algOid = CryptoConfig.MapNameToOID("GOST3411_2012_256");
        }
        ...
        public Gost2012_256SignatureFormatter(AsymmetricAlgorithm key)
            : this()
        {
            if (key == null)
        ...
        public override byte[] CreateSignature(byte[] rgbHash)
        {
            ...
            byte[] sig = _gostKey.SignHash(rgbHash, HashAlgorithmName.Gost3411_2012_256);
            // Do we need it now?
            //Array.Reverse(sig);
            return sig;
        }
