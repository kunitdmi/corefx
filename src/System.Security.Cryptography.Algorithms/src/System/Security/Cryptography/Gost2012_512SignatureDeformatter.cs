...
namespace System.Security.Cryptography
{
    ...
    public class Gost2012_512SignatureDeformatter : AsymmetricSignatureDeformatter
    {
        ...
        /// <summary>
        /// Создание объекта класса <see cref="Gost2012_512SignatureDeformatter"/>.
        /// </summary>
        public Gost2012_512SignatureDeformatter()
        {
            _alg_algOid = CryptoConfig.MapNameToOID(GostConstants.GOST3411_2012_512STRING);
        }
        ...
        public override bool VerifySignature(byte[] rgbHash, byte[] rgbSignature)
        {
            ...
            return _gostKey.VerifyHash(rgbHash, rgbSignature, HashAlgorithmName.Gost3411_2012_512);
        }
