    ...
    public sealed class Gost3410_2012_512CryptoServiceProvider : Gost3410_2012_512, ICspAsymmetricAlgorithm
    {
        ...
        public Gost3410_2012_512CryptoServiceProvider(CspParameters parameters)
        {
            _parameters = CapiHelper.SaveCspParameters(
                CapiHelper.CspAlgorithmType.PROV_GOST_2012_512,
                parameters,
        ...
        public override Gost3410Parameters ExportParameters(bool includePrivateParameters)
        {
            ...
            DecodePublicBlob(obj1, data, CspAlgorithmType.PROV_GOST_2012_512);
        ...
        public override void ImportParameters(Gost3410Parameters parameters)
        {
            ...
            if (Gost3410_2012_512CryptoServiceProvider.IsPublic(parameters))
            {
                ...
                byte[] keyBlob = EncodePublicBlob(pubKey, CspAlgorithmType.PROV_GOST_2012_512);
                CapiHelper.ImportKeyBlob(
                    safeProvHandleTemp,
                    CspProviderFlags.NoFlags,
                    false,
        ...
        //    Gost3410_2012_512Parameters alg)
        //{
        ...
        //    Gost3410_2012_512CspObject obj1 = new Gost3410_2012_512CspObject(alg);
