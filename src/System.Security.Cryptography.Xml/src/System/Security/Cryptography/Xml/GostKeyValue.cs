...
//    /// представляет элемент &lt;KeyInfo&gt;, содержащий открытый ключ ГОСТ 34.10-2001. 
//    /// </para>
...
//    /// ГОСТ 34.10-2001 генерируется случайным образом.</para>
...
//        /// </summary>
//        /// <remarks>При создании нового ключа ГОСТ 34.10-2001 этот конструктор 
//        /// использует реализацию <see cref="CryptoPro.Sharpei.Gost3410"/> по 
//        /// умолчанию, как определено классом 
//        /// <see cref="System.Security.Cryptography.CryptoConfig"/>.</remarks>
//        public GostKeyValue()
//        {
//            m_key = Gost3410.Create();
//        }
...
//        /// <see cref="CryptoPro.Sharpei.Gost3410"/>, в котором содержится открытый 
//        /// ключ.</param>
...
//        /// <summary>
//        /// Возвращает или устаналивает объект <see cref="Gost3410"/>, 
...
//        /// <summary>
//        /// Объект <see cref="Gost3410"/>, которому принадлежит открытый ключ.
//        /// </summary>
//        private Gost3410 m_key;
//    }
//}
